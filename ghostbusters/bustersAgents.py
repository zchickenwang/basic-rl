...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for gPos in ghostPositions:
            gDist = self.distancer.getDistance(gPos, pacmanPosition)
            if gDist < closestDist:
                closest = gPos
                closestDist = gDist
        ...
        for a in legal:
            aDist = self.distancer.getDistance(closest, Actions.getSuccessor(pacmanPosition, a))
            if aDist < bestDist:
                action = a
                bestDist = aDist
