...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.particles:
            probs[pos] += self.getObservationProb(observation, gameState.getPacmanPosition(), pos, self.getJailPosition())
        ...
        for i in range(self.numParticles):
            newParticles.append(probs.sample())
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        """
        self.particles = []
        permsIter = itertools.product(self.legalPositions, repeat=self.numGhosts)
        perms = []
        for p in permsIter:
            perms.append(p)
        ...
        n = len(perms)
        for i in range(self.numParticles):
            self.particles.append(perms[i % n])
